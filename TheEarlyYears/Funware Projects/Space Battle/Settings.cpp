...
void TSettings::GetPrivateString()
{
    ...
    *****************************************/
	...
	// Do we want to skip the intro
    SkipIntro = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Skip Intro", "0" );
...
void TSettings::WritePrivateString()
{
    ...
    *****************************************/
	...
	// Save skip intro
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Skip Intro", SkipIntro );
