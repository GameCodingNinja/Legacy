...
#define REDEFINE_MINZ 80.0f

// Define packed structure, no padding
//#pragma pack(push, 1)

/*
// Force it to check the ceiling
#define CHECK_TEXT_CEILING

// Identify the bad polygons that try to render outside the textures size
#define IDENTIFY_BAD_POLYS

#define POLYGON_COUNT_TO_CHECK  413	// Identifise the polygon object by it's panel count that we are checking
#define MAX_BAD_POLY_ARY        5000	// the array for holding
#define BAD_POLY_OUT_TXT_FILE   "c:\\badpolyDefernerShip.txt"	 // output text file identifing the polygon object
#define BAD_POLY_OUT_BIN_FILE   "c:\\badpolyDefernerShip.bin"	 // output binary file identifing the polygon object
#define DONT_CHECK_PANEL        -1							 // Indicates don't check that panel
*/
...
#define INI_FILE_NAME            "SpaceBattle-Prefs.ini"
#define PRODUCT_NAME             "Space Battle Screen Saver"
#define PROGRAM                  "Space Battle"
#define PRODUCT_VERSION          "Space Battle  Ver 1.1.3"
#define ORDER_FORM_TITLE         "Space Battle Order Form       www.howiesfunware.com"
...
#define FULL_VERSION_NUMBER      "160389-25027"
#define FAKE_VERSION_NUMBER      FULL_VERSION_NUMBER
#define FIRST_TEMP_NUMBER        "27L-231-9C33"
#define SECOND_TEMP_NUMBER       "3E1-5F1-M131"
#define FIRST_CHECK_FILE         "q1yljxO9.dli"
#define SECOND_CHECK_FILE        "l2qdvmwt.dli"
