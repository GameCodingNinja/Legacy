...
protected:
    ...
    *****************************************/
    int Speed, RenderRes;
	BOOL SizeToFit, UseScreenRes;
	COLORREF QuoteColor, RefColor;
...
public:
    ...
    *****************************************/
    ...
    BOOL GetUseScreenRes(){ return UseScreenRes; };
    void SetUseScreenRes( BOOL Value ){ UseScreenRes = Value; };

    // Get the quote color
    COLORREF GetQuoteColor(){ return QuoteColor; };
	void SetQuoteColor( COLORREF Value ){ QuoteColor = Value; };

    // Get the reference color
    COLORREF GetRefColor(){ return RefColor; };
	void SetRefColor( COLORREF Value ){ RefColor = Value; };

	// Get the pointer to the custom colors
    COLORREF *GetPtrCustomColors(){ return CustomColors; };

	// Set the shade type
	int GetShadeType(){ return ShadeType; };
    void SetShadeType( int Value ){ ShadeType = Value; };

	// Shimmer on / off
	BOOL GetShimmer(){ return Shimmer; };
    void SetShimmer( BOOL Value ){ Shimmer = Value; };
