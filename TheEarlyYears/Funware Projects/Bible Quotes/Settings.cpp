...
void TSettings::GetPrivateString()
{
    ...
    *****************************************/
    ...
    RenderRes = GetSettingsInt( IniFilePath, PRODUCT_NAME, "Render Res", "5" );
    // Get Size to fit
    SizeToFit = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Size To Fit", "0" );
    // Did we calculate the render res
    UseScreenRes = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Use Screen Res", "1" );
	...
	// Text Color
    QuoteColor = GetSettingsInt( IniFilePath, PRODUCT_NAME, "Quote Color", "16744448" );

	// Text Color
    RefColor = GetSettingsInt( IniFilePath, PRODUCT_NAME, "Ref Color", "10485760" );

	// Get the shade type
    ShadeType = GetSettingsInt( IniFilePath, PRODUCT_NAME, "Shade Type", "2" );

	// Get shimmer
    Shimmer = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Shimmer", "1" );
    ...
    *****************************************/
    ...
    // Registration number
    lstrcpy( RegNum, GetSettingsChar( IniFilePath, PRODUCT_NAME, "FDMB", FULL_VERSION_NUMBER ) );
...
void TSettings::WritePrivateString()
{
    ...
    *****************************************/
    ...
    // Save cal render res
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Use Screen Res", UseScreenRes );
	...
	SaveIniSetting( IniFilePath, PRODUCT_NAME, "Quote Color", QuoteColor );
	SaveIniSetting( IniFilePath, PRODUCT_NAME, "Ref Color", RefColor );

	SaveIniSetting( IniFilePath, PRODUCT_NAME, "Shade Type", ShadeType );
	SaveIniSetting( IniFilePath, PRODUCT_NAME, "Shimmer", Shimmer );
