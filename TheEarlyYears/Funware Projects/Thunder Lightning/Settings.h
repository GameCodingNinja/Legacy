...
protected:
    ...
    *****************************************/
    int RainAmount, RainType, LightHits, GroupHits, BlackOuts;
    BOOL SoundOn;
...
public:
    ...
    *  Screen saver specific settings
    *****************************************/
    int GetRainType(){ return RainType; };
    void SetRainType( int Value ){ RainType = Value; };

    int GetRainAmount(){ return RainAmount; };
    void SetRainAmount( int Value ){ RainAmount = Value; };

    int GetLightHits(){ return LightHits; };
    void SetLightHits( int Value ){ LightHits = Value; };

    int GetGroupHits(){ return GroupHits; };
    void SetGroupHits( int Value ){ GroupHits = Value; };

    int GetBlackOuts(){ return BlackOuts; };
    void SetBlackOuts( int Value ){ BlackOuts = Value; };

    BOOL GetSoundOn(){ return SoundOn; };
    void SetSoundOn( BOOL Value ){ SoundOn = Value; };
