...
void TSettings::GetPrivateString()
{
    ...
    *****************************************/
    // Get the speed
    SnowAmount = GetSettingsInt( IniFilePath, PRODUCT_NAME, "Snow Amount", "2" );
    // Get the star
    Star = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Star", "1" );
    // Get the lights
    XMasLights = GetSettingsBool( IniFilePath, PRODUCT_NAME, "XMasLights", "1" );
    // Get the Smoke
    Smoke = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Smoke", "1" );
    // Get the Santa
    Santa = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Santa", "1" );
    // Get the Santa
    People = GetSettingsBool( IniFilePath, PRODUCT_NAME, "People", "1" );
    // Get the Disable Duel Monitor
    EnableDuelMonitor = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Enable Duel Monitor", "0" );
...
void TSettings::WritePrivateString()
{
    ...
    *****************************************/
    // Save the speed
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Snow Amount", SnowAmount );
    // Save the star
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Star", Star );
    // Save the Christmas lights
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "XMasLights", XMasLights );
    // Save the Christmas Smoke
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Smoke", Smoke );
    // Save the Santa
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Santa", Santa );
    // Save the People
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "People", People );
	// Save the People
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Enable Duel Monitor", EnableDuelMonitor );
