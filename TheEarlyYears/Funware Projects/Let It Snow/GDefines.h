...
#define INI_FILE_NAME            "Let It Snow-Prefs.ini"
#define PRODUCT_NAME             "Let It Snow Screen Saver"
#define PROGRAM                  "Let It Snow"
#define PRODUCT_VERSION          "Let It Snow  Ver 1.2.3"
#define ORDER_FORM_TITLE         "Let It Snow Order Form       www.howiesfunware.com"
...
#define REG_FEE_INFO             "Music options are only available to registered users. Please register by paying the registration fee. Click on the Order Form button for payment options."
...
#define FULL_VERSION_NUMBER      "100352-50779"
#define FAKE_VERSION_NUMBER      FULL_VERSION_NUMBER
#define FIRST_TEMP_NUMBER        "18X-200-9H01"
#define SECOND_TEMP_NUMBER       "9Y1-110-Z510"
#define FIRST_CHECK_FILE         "y1llfxh9.dli"
#define SECOND_CHECK_FILE        "34bdvoyt.dli"
...
#define CHK_STAR				 404
#define CHK_XMAS_LITES			 405
#define CHK_SMOKE	             406
#define CHK_PEOPLE	             407
#define CHK_SANTA	             408
#define CHK_ENABLE_DUAL	         409

// Scroll bars and boxes
#define SCR_SNOW_AMOUNT	         501
