...
void TSettings::GetPrivateString()
{
    ...
    *****************************************/
    ...
    // Get twinkle stars
    TwinkleStars = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Twinkle Stars", "1" );
    // Get rotate flag
    RotateFlag = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Rotate Flag", "1" );
...
void TSettings::WritePrivateString()
{
    ...
    *****************************************/
    ...
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Twinkle Stars", TwinkleStars );
    // Save the Rotate Flag
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Rotate Flag", RotateFlag );
