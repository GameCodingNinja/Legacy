...
protected:
    ...
    *****************************************/
    int RenderRes;
    BOOL SizeToFit, CalcRenderRes, TwinkleStars; 
    BOOL RotateFlag, Force16BitColor;
...
public:
    ...
    *****************************************/
    ...
    BOOL GetTwinkleStars(){ return TwinkleStars; };
    void SetTwinkleStars( BOOL Value ){ TwinkleStars = Value; };

    BOOL GetRotateFlag(){ return RotateFlag; };
    void SetRotateFlag( BOOL Value ){ RotateFlag = Value; };
