...
void TSettings::GetPrivateString()
{
    ...
    *****************************************/
    ...
    // Get the firework count
    FireworkCount = GetSettingsInt( IniFilePath, PRODUCT_NAME, "Firework Count", "3" );
    // Get the burst angle
    BurstAngle = GetSettingsInt( IniFilePath, PRODUCT_NAME, "Burst Angle", "1" );
...
void TSettings::WritePrivateString()
{
    ...
    *****************************************/
    ...
    // Save the firework count
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Firework Count", FireworkCount );
    // Save the burst angle
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Burst Angle", BurstAngle );
    // Save the Sound On
