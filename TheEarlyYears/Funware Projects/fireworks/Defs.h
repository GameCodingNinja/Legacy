...
#define MAX_EXPLODE_SNDS              9
#define MAX_SHOOT_SNDS				  8

#define LIGHT_SOURCE_X				  271.0F
#define LIGHT_SOURCE_Y				  -279.0F
#define LIGHT_SOURCE_Z				  100.0F

#define MAX_PARTICLE_BURST            900
#define MAX_FIREWORKS				  10
#define MAX_FLARE_FRAMES              13
#define MAX_FLARE_IMAGES              4
#define MAX_COLORS                    8
#define WHITE_COLOR                   8
#define STAR_8_BIT_COLOR              177
