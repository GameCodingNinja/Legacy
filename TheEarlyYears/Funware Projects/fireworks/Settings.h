...
protected:
    ...
    *****************************************/
    int RenderRes, FireworkCount, BurstAngle;
    BOOL SizeToFit, CalcRenderRes, SoundOn, Force16BitColor;
...
public:
    ...
    *****************************************/
    ...
    int GetFireworkCount(){ return FireworkCount; };
    void SetFireworkCount( int Value ){ FireworkCount = Value; };

    int GetBurstAngle(){ return BurstAngle; };
    void SetBurstAngle( int Value ){ BurstAngle = Value; };
