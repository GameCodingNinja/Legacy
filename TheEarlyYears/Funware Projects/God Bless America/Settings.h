...
public:
    ...
    *  Screen saver specific settings
    *****************************************/
    int GetSpeed(){ return FSpeed; };
    void SaveSpeed( int Speed ){ FSpeed = Speed; };
    ...
    *****************************************/
    ...
    BOOL GetLoadYourOwnOnOff(){ return LoadYourOwnOnOff; };
    void SaveLoadYourOwnOnOff( BOOL Value ){ LoadYourOwnOnOff = Value; };
