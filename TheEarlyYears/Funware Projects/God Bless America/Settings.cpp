...
void TSettings::GetPrivateString()
{
    ...
    *****************************************/
    // Get the speed
    FSpeed = GetSettingsInt( IniFilePath, PRODUCT_NAME, "Speed", "2" );
    ...
    *****************************************/
    ...
    MusicOff = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Sound On or Off", "1" );
    // Do we play the space song
    ThemeMusicOn = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Play Song", "0" );
    // Do we play our own songs
    LoadYourOwnOnOff = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Load your own", "0" );
    ...
    *****************************************/
    ...
    FOrderFrmHelpWnd = GetSettingsBool( IniFilePath, ORDER_FORM, "Order Form Help", "1" );    
...
void TSettings::WritePrivateString()
{
    ...
    *****************************************/
    // Save the speed
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Speed", FSpeed );
    ...
    *****************************************/
    ...
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Sound On or Off", MusicOff );
    // Save if we play the space song
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Play Song",ThemeMusicOn );
    // Save if we play our own songs
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Load your own", LoadYourOwnOnOff );
...
void TSettings::WriteHelpHintSettings()
{
    ...
    SaveIniSetting( INI_FILE_NAME, ORDER_FORM, "Order Form Help", FOrderFrmHelpWnd );
    // Save if they want to see the intro window again
    SaveIniSetting( INI_FILE_NAME, PRODUCT_NAME, "Intro Help", FIntroHelpWnd );
