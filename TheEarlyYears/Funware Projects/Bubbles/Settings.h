...
protected:
    ...
    *****************************************/
    int BubbleCount, PopAmount, FloatMode, Speed;
    BOOL SoundOn, BubblePopOn;
...
public:
    ...
    *  Screen saver specific settings
    *****************************************/
    int GetBubbleCount(){ return BubbleCount; };
    void SetBubbleCount( int Value ){ BubbleCount = Value; };

    int GetPopAmount(){ return PopAmount; };
    void SetPopAmount( int Value ){ PopAmount = Value; };

    int GetFloatMode(){ return FloatMode; };
    void SetFloatMode( int Value ){ FloatMode = Value; };

    BOOL GetSoundOn(){ return SoundOn; };
    void SetSoundOn( BOOL Value ){ SoundOn = Value; };

    BOOL GetBubblePopOn(){ return BubblePopOn; };
    void SetBubblePopOn( BOOL Value ){ BubblePopOn = Value; };
