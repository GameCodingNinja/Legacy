...
void TSettings::GetPrivateString()
{
    ...
    *****************************************/
    // Do we animate the mouse
    AnimateMouse = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Animate Mouse", "1" );
    // Do we animate the santa clock
    AnimateSanta = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Animate Santa", "1" );
    // Do we animate the tree
    AnimateTree = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Animate Tree", "1" );
    // Do we animate the cat
    AnimateCat = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Animate Cat", "1" );
...
void TSettings::WritePrivateString()
{
    ...
    *  Screen saver specific settings
    *****************************************/
    // Save the mouse animationg
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Animate Mouse", AnimateMouse );
    // Save the santa clock animationg
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Animate Santa", AnimateSanta );
    // Save the tree animationg
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Animate Tree", AnimateTree );
    // Save the cat animationg
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Animate Cat", AnimateCat );
