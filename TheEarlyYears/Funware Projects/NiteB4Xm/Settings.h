...
protected:
    ...
    *****************************************/
    BOOL AnimateMouse, AnimateSanta, AnimateTree, AnimateCat;
...
public:
    ...
    *  Screen saver specific settings
    *****************************************/
    BOOL GetAnimateMouse(){ return AnimateMouse; };
    void SetAnimateMouse( BOOL Value ){ AnimateMouse = Value; };
    BOOL GetAnimateSanta(){ return AnimateSanta; };
    void SetAnimateSanta( BOOL Value ){ AnimateSanta = Value; };
    BOOL GetAnimateTree(){ return AnimateTree; };
    void SetAnimateTree( BOOL Value ){ AnimateTree = Value; };
    BOOL GetAnimateCat(){ return AnimateCat; };
    void SetAnimateCat( BOOL Value ){ AnimateCat = Value; };
    ...
    *****************************************/
    ...
    void SaveSoundDir( char *text ){ lstrcpy( SoundDirectory, text ); };
    BOOL GetRandomMusic(){ return RandomMusic; };
    void SaveRandomMusic( BOOL Value ){ RandomMusic = Value; };
