...
void TSettings::GetPrivateString()
{
    ...
    *****************************************/
    ...
    RandomList = GetSettingsBool( IniFilePath, PRODUCT_NAME, "RandomList", "1" );
	TimeOut = GetSettingsInt( IniFilePath, PRODUCT_NAME, "TimeOut", "4" );
...
void TSettings::WritePrivateString()
{
    ...
    *****************************************/
    ...
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "RandomList", RandomList );
	SaveIniSetting( IniFilePath, PRODUCT_NAME, "TimeOut", TimeOut );
