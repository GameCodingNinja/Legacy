...
#include "CMesh.h"           // Opengl mesh class
#include "CollisionTypes.h"  // Collision type specifiers
...
protected:
    ...
    //bool MatchVertsToGlobalList( CObjList &vertLst, CObjList &faceLst );
    // Match vertices to local list
    bool MatchVertsToLocalList( CGroupLst &groupLst );
    // Save polygon object data to file
    //bool SaveToFile_Condenced( CObjList &vertLst, CObjList &faceLst, CGroupLst &groupLst, char *fileName );
    // Save polygon object data to file
    ...
    // Decode the matrix
    void Decode_Matrix( char *strData, int strCount );
    // Decode the center
    void Decode_Center( char *strData, int strCount );
    ...
    //bool MakeGlobalVertLst( CGroupLst &groupLst, CObjList &vertLst );
    // Make a global face list
    //bool MakeGlobalFaceLst( CGroupLst &groupLst, CObjList &faceLst );
