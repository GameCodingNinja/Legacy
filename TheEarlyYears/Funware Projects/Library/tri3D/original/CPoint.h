...
class CPoint2D
{
	...
	CPoint2D():x(0),y(0),z(0),U(0),V(0),rI(0),gI(0),bI(0),I(0),
...
class CPoint3D
{
	...
	// value of 1/z
	float oneOverZ;
	// value of the 1/z	fix point
	int oneOverZfixPoint;
    ...
    CPoint3D():x(0),y(0),z(0),tx(0),ty(0),tz(0),px(0),py(0),
              oneOverZ(0),oneOverZfixPoint(0),fProjected(false)
    {}
...
public:
	...
	CUVI():U(0),V(0),rI(0),gI(0),bI(0),I(0)
	{}
};
