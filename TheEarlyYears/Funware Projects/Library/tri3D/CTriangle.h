...
#define SHIFT_24_MASK        0xFF000000  // Mask out the top 8 bits for a 32 bit shift int
...
#define SHIFT_16_MASK        0xFFFF8000  // Mask out the top 16 bits for a 32 bit shift int
...
public:
	...
	// Get the a specific point of the triangle
    ...
    void _fastcall Render_ZBufShadingTxtPos( PCTextureLib pTextLib );
	void _fastcall Render_ZBufShadingTxtNeg( PCTextureLib pTextLib );
