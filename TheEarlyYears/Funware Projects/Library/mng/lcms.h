...
#define icSigHexachromeData      (0x4d434836)                           // MCH6
...
#define D50X  (0.964294)
#define D50Y  (1.0)
#define D50Z  (0.825104)
#define D50x  (0.345868)
#define D50y  (0.357545)
...
LCMSAPI HANDLE        LCMSEXPORT cmsCIECAM97sInit(LPcmsViewingConditions pVC2);
LCMSAPI void          LCMSEXPORT cmsCIECAM97sDone(HANDLE hModel);
LCMSAPI void          LCMSEXPORT cmsCIECAM97sForward(HANDLE hModel, LPcmsCIEXYZ pIn, LPcmsJCh pOut);
LCMSAPI void          LCMSEXPORT cmsCIECAM97sReverse(HANDLE hModel, LPcmsJCh pIn,    LPcmsCIEXYZ pOut);
...
int cdecl cmsSample3DGrid(LPLUT Lut, _cmsSAMPLER Sampler, LPVOID Cargo, DWORD dwFlags);

// Precalculate device link
BOOL cdecl _cmsPrecalculateDeviceLink(_LPcmsTRANSFORM p, int PrecissionLevel);

// Recompute gamut boundary
