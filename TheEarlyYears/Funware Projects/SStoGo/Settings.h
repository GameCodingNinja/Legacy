...
protected:
    ...
    int  FWindowX, FWindowY, DefTxtJust, DelayInSec;
    ...
    char ProjectBKArtPath[ MAX_PATH  ];
...
public:
    ...
    int GetDefTxtJust(){ return DefTxtJust; };
    void SetDefTxtJust( int TxtJust ){ DefTxtJust = TxtJust; };
    COLORREF GetDefTxtColor(){ return DefTxtColor; };
    void SetDefTxtColor( COLORREF TxtColor ){ DefTxtColor = TxtColor; };
    int GetDelayInSec(){ return DelayInSec; };
    void SetDelayInSec( int Delay ){ DelayInSec = Delay; };
    ...
    // Path to project art files
    char *GetProjectBKArtPath(){ return ProjectBKArtPath; };
