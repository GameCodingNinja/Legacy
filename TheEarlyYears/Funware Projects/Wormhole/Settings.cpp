...
void TSettings::GetPrivateString()
{
    ...
    *****************************************/
    ...
    // Get Render Speed
    RenderSpeed = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Render Speed", "0" );
    // Did we calculate the render res
    CalcRenderRes = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Cal Render Res", "1" );
    // get random camers
    RandomCamera = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Random Camera", "1" );
    // get random rotation
    RandomRot = GetSettingsBool( IniFilePath, PRODUCT_NAME, "Random Rot", "1" );
...
void TSettings::WritePrivateString()
{
    ...
    *****************************************/
    ...
    // Save the Size To Fit
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Render Speed", RenderSpeed );
    // Save the Size To Fit
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Cal Render Res", CalcRenderRes );
    // Save random camera
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Random Camera", RandomCamera );
    // Save random rotation
    SaveIniSetting( IniFilePath, PRODUCT_NAME, "Random Rot", RandomRot );
