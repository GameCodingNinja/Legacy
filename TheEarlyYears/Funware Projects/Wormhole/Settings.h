...
protected:
    ...
    *****************************************/
    int RenderRes, RenderSpeed;
    BOOL SizeToFit, CalcRenderRes, RandomCamera, RandomRot;
...
public:
    ...
    *****************************************/
    ...
    BOOL GetRenderSpeed(){ return RenderSpeed; };
    void SetRenderSpeed( BOOL Value ){ RenderSpeed = Value; };

    bool GetCalcRenderRes(){ return CalcRenderRes; };
    void SetCalcRenderRes( bool Value ){ CalcRenderRes = Value; };

    bool GetRandomCamera(){ return RandomCamera; };
    void SetRandomCamera( bool Value ){ RandomCamera = Value; };

    bool GetRandomRot(){ return RandomRot; };
    void SetRandomRot( bool Value ){ RandomRot = Value; };
