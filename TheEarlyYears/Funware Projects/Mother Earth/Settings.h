...
protected:
    ...
    *****************************************/
    int Speed, RenderRes, PolyRes, ShadeType;
	BOOL SizeToFit, CalcRenderRes, Force16BitColor;
	char LoadCustomTxt[MAX_PATH], CustomPath[MAX_PATH];
...
public:
    ...
    *****************************************/
    ...
    int GetPolyRes(){ return PolyRes; };
    void SetPolyRes( int Value ){ PolyRes = Value; };
	...
	char *GetCustomTextureFileName(){ return LoadCustomTxt; };
	char *GetCustomPath(){ return CustomPath; };
