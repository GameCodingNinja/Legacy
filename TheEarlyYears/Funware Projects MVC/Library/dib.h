...
protected:
    ...
    bool ClipRects( CDib *pBitmap, RECT &Dest, RECT &Source );
...
public:
    ...
    // Software blit
    void Blit( CDib *pBitmap, RECT &Dest, RECT &Source, bool clipRect = false );
