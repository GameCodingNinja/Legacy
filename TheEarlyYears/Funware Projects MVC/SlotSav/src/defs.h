...
#define MAX_JOG_COUNT                 18
#define REEL_STOP_DELAY               400
#define DEFAULT_TIMER_SPEED           30
#define REEL_SPIN_TIME                5
#define DEF_SCREEN_WIDTH              1024
#define DEF_SCREEN_HEIGHT             768

#define REEL_X_OFFSET				  180
#define SPIN_START_VEL                -1.5f
#define SPIN_START_ACC                0.15f
#define MAX_SPIN_SPEED                20
#define TIMER_INC                     0.6f

#define X_REEL_OFFSET				  75
#define Y_REEL_OFFSET				  108
