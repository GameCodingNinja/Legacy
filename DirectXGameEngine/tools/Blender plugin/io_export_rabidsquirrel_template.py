...
bl_info = {
    "name": "Export Rabid Squirrel Level(.xml)",
    "author": "Rosenorn",
    "version": (1, 0),
    "blender": (2, 5, 9),
    "api": 37702,
    "location": "File > Export > Rabid Squirrel Level (.xml)",
...
#************************************************************************
class Export_RabidSquirrel_Level(bpy.types.Operator):
    '''Exports scene as Rabid Squirrel Level .xml file.'''
    bl_idname = "export_scene.xml"
    bl_label = "Export Rabid Squirrel Level (.xml)"
...
def menu_func(self, context):
    self.layout.operator(Export_RabidSquirrel_Level.bl_idname, text="Export Rabid Squirrel level (.xml)")
