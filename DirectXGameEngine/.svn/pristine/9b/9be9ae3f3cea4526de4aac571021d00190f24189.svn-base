...
void CSaveFile::InitNewGameFile()
{
    ...
    // Setup the default starting values of the hud progress bars
    shipHealth.SetMaxValue(200);
    shipHealth.SetCurrentValue(88);

    shipShields.SetMaxValue(100);
    shipShields.SetCurrentValue(78);

    shipFuel.SetMaxValue(200);
    shipFuel.SetCurrentValue(33);

    shipAmmoTierVec[EAT_AMMO_TIER_1].SetMaxValue(500);
    shipAmmoTierVec[EAT_AMMO_TIER_1].SetCurrentValue(374);

    shipAmmoTierVec[EAT_AMMO_TIER_2].SetMaxValue(300);
    shipAmmoTierVec[EAT_AMMO_TIER_2].SetCurrentValue(179);

    shipAmmoTierVec[EAT_AMMO_TIER_3].SetMaxValue(100);
    shipAmmoTierVec[EAT_AMMO_TIER_3].SetCurrentValue(10);

    shipAmmoTierVec[EAT_AMMO_TIER_4].SetMaxValue(5);
    shipAmmoTierVec[EAT_AMMO_TIER_4].SetCurrentValue(2);
