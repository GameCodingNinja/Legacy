...
CStartUpState::CStartUpState()
{
    ...
    poweredByWaffles.Init( "(startup)", "waffles" );
...
DWORD CStartUpState::Load()
{
    try
    {
        ...
        // Load the data list table
        CObjectDataList3D::Instance().LoadListTable( "data/objects/3d/objectDataList/dataListTable.lst" );
        ...
        CStageDataList::Instance().LoadFromXML( "data/objects/3d/stageDataList.lst" );
